...
$string['deletequestionsallversioncheck'] = 'This will delete all versions of the following questions:<br /><br />{$a}';
$string['deletequestionscheck'] = 'This will delete the following questions:<br /><br />{$a}';
$string['deleteselectedquestioncheck'] = 'This will delete selected versions of the following question:<br /><br />{$a}';
$string['deletequestionstitle'] = 'Delete question(s)?';
