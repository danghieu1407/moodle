...
/**
 * Web service method to get the properties of quiz section heading.
 *
...
class get_section_title extends external_api {
    ...
    /**
     * Get section heading of the quiz.
     *
     * @param int $id The section id.
     * @param int $quizid The quiz id.
     * @return array An array of the properties of quiz section heading.
     */
    public static function execute(int $id, int $quizid): array {
        ...
        return ['instancesection' => $section->heading];
    }
    ...
    public static function execute_returns(): ?external_description {
        return new external_single_structure([
            'instancesection' => new external_value(PARAM_TEXT, 'The section heading'),
        ]);
    }
}