...
class update_section_title extends external_api {
    ...
    public static function execute_parameters(): external_function_parameters {
        return new external_function_parameters([
            ...
            'newheading' => new external_value(PARAM_TEXT, 'The new heading of the section', VALUE_DEFAULT, ''),
        ]);
    }
     ...
     */
    public static function execute(int $quizid, int $id = 0, string $newheading = ''): array {
