...
/**
 * Select multiple button in question quiz.
 *
 * @package   mod_quiz
 * @category  output
 ...
 */
class selectmultiple_button implements renderable, templatable {
    ...
    public function export_for_template(renderer_base $output): array {
        ...
        $selectmultipleitems = html_writer::tag('button', get_string('selectmultipleitems', 'quiz'), $buttonoptions);

        return [
            'selectmultiple' => $selectmultipleitems,
        ];
    }
}
