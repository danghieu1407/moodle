...
class version_test extends \advanced_testcase {
    ...
    /**
     * Test the get_current_version_of_questions function.
     *
     * @covers ::get_current_version_of_questions
     */
    public function test_get_current_version_of_questions(): void {
        global $DB;
        ...
        $currentversions = question_bank::get_current_version_of_questions([$question->id]);
