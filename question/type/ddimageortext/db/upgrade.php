...
function xmldb_qtype_ddimageortext_upgrade($oldversion) {
    ...
    if ($oldversion < 2024100900) {
        ...
        $field = new xmldb_field('transparentdropzone', XMLDB_TYPE_INTEGER, '1', null, XMLDB_NOTNULL, null, '0', 'shownumcorrect');
        ...
        upgrade_plugin_savepoint(true, 2024100900, 'qtype', 'ddimageortext');
    }
